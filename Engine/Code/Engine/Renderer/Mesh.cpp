...
Mesh* Mesh::CreateQuadImmediateInLine(eVertexType type, const Vector3& v1, const Vector3& v2,
	const Vector3& v3, const Vector3& v4, const Vector3& v5, 
	const Vector3& v6, const Vector3& v7, const Vector3& v8,
	const Rgba& color)
{
	MeshBuilder mb;
...
Mesh* Mesh::CreateQuad20(eVertexType type)
{
	...
	Vector3 center = Vector3::ZERO;
	Vector3 size = Vector3(20.f, 20.f, 1.f);
